...
def plotMu(rescale):
	...
	if (rescale==1):
		...
		cbar = plt.colorbar()
		cbar.set_label(r'$\xi^{ff}(\, \overrightarrow{s} \, [h^{-1}.Mpc])$',size=40)
	if (rescale==2):
		plt.imshow(xxx*xxx*yyy, origin='lower', interpolation='None',extent=[0., 1.,min1D, max1D],aspect='auto')
		cbar = plt.colorbar()
		cbar.set_label(r'$\xi^{ff}(\, \overrightarrow{s} \, [(h^{-1}.Mpc)^{2}])$',size=40)
...
xi1D_dd, xi2D_dd, xiMu_dd, xiWe_dd = loadData('/home/gpfs/manip/mnt0607/bao/hdumasde/Results/Txt/FitsFile_DR12_Guy/xi_A_delta_delta_Mu_LYA.txt','/home/gpfs/manip/mnt0607/bao/hdumasde/Results/Txt/FitsFile_DR12_Guy/xi_A_delta_delta_2D_LYA.txt')
xi1D_ss, xi2D_ss, xiMu_ss, xiWe_ss = loadData('/home/gpfs/manip/mnt0607/bao/hdumasde/Results/Txt/v1519_2/xi_A_delta_delta_Mu_LYA_JMC.txt','/home/gpfs/manip/mnt0607/bao/hdumasde/Results/Txt/v1519_2/xi_A_delta_delta_2D_LYA_JMC.txt')
...
for i in range(0,3):
	...
	plt.errorbar(xi1D_ss[:,0], coef*xi1D_ss[:,1], yerr=coef*xi1D_ss[:,2], fmt='o',label='simulation',  markersize=8, elinewidth=6, color='blue')
	plt.errorbar(xi1D_dd[:,0], coef*xi1D_dd[:,1], yerr=coef*xi1D_dd[:,2], fmt='o',label='data',  markersize=8, elinewidth=6, color='red')
	plt.ylabel(r'$\xi^{ff} (|s|)$', fontsize=40)
...
xi1D_, xi2D_, xiMu_, xiWe_ = loadData('/home/gpfs/manip/mnt0607/bao/hdumasde/Results/Txt/v1519_2/xi_A_delta_delta_Mu_LYA_JMC.txt','/home/gpfs/manip/mnt0607/bao/hdumasde/Results/Txt/v1519_2/xi_A_delta_delta_2D_LYA_JMC.txt')
plot_Xi_1D(0)
plot_Xi_1D(1)
plot_Xi_1D(2)
plot_Xi_2D(0)
